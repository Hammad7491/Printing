{{-- resources/views/ballons/section2.blade.php --}}
<section class="gx-villa" id="gxBalloonGallery" aria-label="Balloons & Arches Gallery">
            ...
            <div class="gx-gal" data-gx-gallery>
                <div class="gx-gal-main">
                    <img
                        ...
                        src="{{ asset('assets/images/ballons/ballon3.jpeg') }}"
                        alt="Balloons & Arches"
                        loading="eager"
                        decoding="async"
                    />
                ...
                {{-- Thumbnails (5 images) --}}
                <div class="gx-gal-thumbs" role="list" aria-label="Balloons & Arches gallery thumbnails">
                    <button class="gx-thumb is-active" type="button" role="listitem"
                            data-src="{{ asset('assets/images/ballons/ballon1.jpeg') }}" aria-label="View image 1">
                        <img src="{{ asset('assets/images/ballons/ballon1.jpeg') }}" alt="Balloon thumbnail 1" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/ballons/ballon2.jpeg') }}" aria-label="View image 2">
                        <img src="{{ asset('assets/images/ballons/ballon2.jpeg') }}" alt="Balloon thumbnail 2" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/ballons/ballon4.jpeg') }}" aria-label="View image 3">
                        <img src="{{ asset('assets/images/ballons/ballon4.jpeg') }}" alt="Balloon thumbnail 3" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/ballons/ballon5.jpeg') }}" aria-label="View image 4">
                        <img src="{{ asset('assets/images/ballons/ballon5.jpeg') }}" alt="Balloon thumbnail 4" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/ballons/ballon6.jpeg') }}" aria-label="View image 5">
                        <img src="{{ asset('assets/images/ballons/ballon6.jpeg') }}" alt="Balloon thumbnail 5" loading="lazy" decoding="async">
                    </button>
                </div>
            </div>
        </div>
...
{{-- FAQ SECTION --}}
<section class="gx-faqs" id="gxBalloonFaqs" aria-label="Frequently Asked Questions">
    <div class="gx-container">
            ...
            <div class="gx-faq-list" data-gx-faq>
                <div class="gx-faq is-open">
                    <button class="gx-q" type="button" aria-expanded="true">
                        What details do you need to start my balloon arch order?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a">
                        <p>
                            Share the event date, location, theme/colors, and the space size (wall/backdrop width). If you have a reference
                            photo, send it — we’ll suggest the best arch style and size.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Can balloon arches work outdoors?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            Yes. For outdoor setups we use stronger frames and stability support (like weighted bases). Wind and heat can affect
                            balloons, so we recommend shaded placement when possible.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    ...
                    <div class="gx-a" hidden>
                        <p>
                            Garland/air-filled balloons typically last much longer than helium balloons. Helium float time depends on balloon size
                            and treatments (like Hi-Float). We’ll guide you based on your event duration.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Do you offer custom colors and add-ons?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            Yes. We can match themes and add extras like foil balloons, florals, LED accents, and backdrop styling depending on
                            your requirements.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    ...
                    <div class="gx-a" hidden>
                        <p>
                            Yes — we can deliver and install on-site for a clean and professional finish. If you need a DIY kit, we can also
                            prepare it with simple instructions.
                        </p>
                    </div>
                </div>
            </div>
...
.gx-villa-center{ display:flex; justify-content:center; }
