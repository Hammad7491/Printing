{{-- resources/views/ballons/section1.blade.php --}}
<section class="gx-prod" id="gxBalloonProduct" aria-label="Balloons & Arches Details">
        ...
        <div class="gx-prod-wrap">
            ...
            <div class="gx-prod-left">
                <div class="gx-prod-media">
                    <img
                        class="gx-prod-img"
                        src="{{ asset('assets/images/ballons/ballon2.jpeg') }}"
                        alt="Balloons & Arches"
                        loading="lazy"
                        decoding="async"
                    />
            ...
            <div class="gx-prod-right">
                <div class="gx-prod-head">
                    <h1 class="gx-prod-title">Balloons &amp; Arches</h1>
                    <p class="gx-prod-sub">
                        Premium balloon garlands &amp; arches for events — clean styling, strong structure, and perfect color matching.
                    </p>
                </div>
                ...
                <div class="gx-details">
                    ...
                    <div class="gx-section">
                        ...
                        <p class="gx-sec-text">
                            Ideal for birthdays, weddings, store openings, baby showers, and corporate events. We design balloon
                            arches/garlands with balanced sizing and professional installation for a premium look.
                        </p>

                        <ul class="gx-bullets">
                            <li>Custom themes, colors &amp; sizes</li>
                            <li>Strong frame/structure for clean shape</li>
                            <li>Indoor &amp; outdoor setup options</li>
                        </ul>
                    </div>
                    ...
                    <div class="gx-section gx-section--specs">
                        ...
                        <div class="gx-specrows" role="list">
                            <div class="gx-specrow" role="listitem">
                                ...
                                <div class="gx-spec-v">
                                    Premium Latex Balloons (5&quot;, 10/12&quot;, 18&quot; options), Foil Balloons (optional), Balloon Garland Strip/Tape
                                </div>
                            </div>
                            ...
                            <div class="gx-specrow" role="listitem">
                                ...
                                <div class="gx-spec-v">
                                    Arch Stand/Frame (PVC/Metal options), Water-weight Base (for stability), Glue Dots, Fishing Line, Zip Ties, Air Pump
                                </div>
                            </div>
                            ...
                            <div class="gx-specrow" role="listitem">
                                ...
                                <div class="gx-spec-v">
                                    Organic Garland Style, Circle Arch, Half Arch, Backdrop Setup, LED/Florals Add-ons, Helium Add-ons (on request)
                                </div>
                            </div>
                        </div>
                    </div>
