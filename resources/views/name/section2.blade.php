{{-- resources/views/name/section2.blade.php --}}

{{-- GALLERY SECTION --}}
<section class="gx-name" id="gxNameGallery" aria-label="Name &amp; Board Sign Gallery">
    <div class="gx-container">

        {{-- ✅ ONLY Gallery (Responsive for all devices) --}}
        <div class="gx-name-center">
            <div class="gx-gal" data-gx-gallery>
                <div class="gx-gal-main">
                    <img
                        class="gx-gal-mainimg"
                        src="{{ asset('assets/images/Name/Name6.jpg') }}"
                        alt="Name &amp; Board Sign"
                        loading="eager"
                        decoding="async"
                    />
                ...
                {{-- Thumbnails (5 images) — ✅ no repeat of Name7.webp used in Section 1 --}}
                <div class="gx-gal-thumbs" role="list" aria-label="Name &amp; Board Sign gallery thumbnails">
                    <button class="gx-thumb is-active" type="button" role="listitem"
                            data-src="{{ asset('assets/images/Name/Name1.jpg') }}" aria-label="View image 1">
                        <img src="{{ asset('assets/images/Name/Name1.jpg') }}" alt="Name board thumbnail 1" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/Name/Name2.jpg') }}" aria-label="View image 2">
                        <img src="{{ asset('assets/images/Name/Name2.jpg') }}" alt="Name board thumbnail 2" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/Name/Name3.jpg') }}" aria-label="View image 3">
                        <img src="{{ asset('assets/images/Name/Name3.jpg') }}" alt="Name board thumbnail 3" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/Name/Name4.jpg') }}" aria-label="View image 4">
                        <img src="{{ asset('assets/images/Name/Name4.jpg') }}" alt="Name board thumbnail 4" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/Name/Name5.jpg') }}" aria-label="View image 5">
                        <img src="{{ asset('assets/images/Name/Name5.jpg') }}" alt="Name board thumbnail 5" loading="lazy" decoding="async">
                    </button>
                </div>
            </div>
        </div>
...
{{-- FAQ SECTION --}}
<section class="gx-faqs" id="gxNameFaqs" aria-label="Frequently Asked Questions">
    <div class="gx-container">
        <div class="gx-faq-card">
            ...
            <div class="gx-faq-list" data-gx-faq>
                <div class="gx-faq is-open">
                    ...
                    <div class="gx-a">
                        <p>
                            Send your business/office name, preferred size, color theme, and any logo (optional). If you have a reference
                            style, share it and we’ll match the look.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    ...
                    <div class="gx-a" hidden>
                        <p>
                            For outdoor boards, ACP/ACM and aluminum are strong choices. Acrylic also works well depending on placement.
                            We’ll recommend the best option based on sunlight, rain, and mounting surface.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Do you offer 3D raised letters or standoff mounting?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            Yes. You can choose flat printed boards or premium 3D letters with standoffs for a more high-end, dimensional look.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Can you install it, or do you provide mounting hardware?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            We can guide you for installation and provide the required hardware (tape, screws, standoffs) depending on the chosen style.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    ...
                    <div class="gx-a" hidden>
                        <p>
                            Production time depends on size and finishing (flat print vs 3D letters). Most orders are completed quickly after design approval.
                        </p>
                    </div>
                </div>
            </div>
...
.gx-name *, .gx-faqs *{ box-sizing: border-box; }

/* Scoped container (won't break other pages) */
.gx-name .gx-container,
...
/* ===== Name layout (CENTER ONLY) ===== */
.gx-name{ padding: 18px 0 16px; }
