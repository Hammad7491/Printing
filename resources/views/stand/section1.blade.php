{{-- ========================= --}}
{{-- ✅ STANDS PAGE - SECTION 1 --}}
{{-- resources/views/stands/section1.blade.php --}}
{{-- ========================= --}}
<section class="gx-prod" id="gxStandProduct" aria-label="Stands Details">
        ...
        <div class="gx-prod-wrap">
            ...
            <div class="gx-prod-left">
                <div class="gx-prod-media">
                    <img
                        class="gx-prod-img"
                        src="{{ asset('assets/images/stands/stand3.jpeg') }}"
                        alt="Stands"
                        loading="lazy"
                        decoding="async"
                    />
            ...
            <div class="gx-prod-right">
                <div class="gx-prod-head">
                    <h1 class="gx-prod-title">Stands</h1>
                    <p class="gx-prod-sub">
                        Premium display stands for indoor/outdoor branding — clean finishing, stable support, and professional look.
                    </p>
                </div>
                ...
                <div class="gx-details">
                    ...
                    <div class="gx-section">
                        ...
                        <p class="gx-sec-text">
                            Perfect for reception areas, counters, events, and storefront promotions. Our stands help your message
                            stay visible with a neat, premium presentation—ideal for menus, QR codes, offers, name plates, and branding.
                        </p>

                        <ul class="gx-bullets">
                            <li>Stable &amp; professional display for signage</li>
                            <li>Custom sizes, shapes &amp; printing options</li>
                            <li>Easy setup with clean mounting/support</li>
                        </ul>
                    </div>
                    ...
                    <div class="gx-section gx-section--specs">
                        ...
                        <div class="gx-specrows" role="list">
                            <div class="gx-specrow" role="listitem">
                                ...
                                <div class="gx-spec-v">Acrylic (clear), PVC Foam Board (Foamex), Aluminum / Stainless Steel (optional)</div>
                            </div>

                            <div class="gx-specrow" role="listitem">
                                <div class="gx-spec-k">Supporting Material:</div>
                                <div class="gx-spec-v">Acrylic Base / Standoffs, Easel Back Support, Screws, Double Sided Tape, Silicon Glue</div>
                            </div>

                            <div class="gx-specrow" role="listitem">
                                <div class="gx-spec-k">Printing &amp; Finish:</div>
                                <div class="gx-spec-v">UV Printing (single/second surface), Matte/Gloss finishing, Cut-to-shape options</div>
                            </div>

                            <div class="gx-specrow" role="listitem">
                                <div class="gx-spec-k">Common Thickness:</div>
                                <div class="gx-spec-v">Acrylic 3–4mm (base up to 5mm) • Foam Board 1–10mm (as per requirement)</div>
                            </div>
                        </div>
                    </div>
                </div>
