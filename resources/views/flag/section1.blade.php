{{-- resources/views/flags/section1.blade.php --}}
<section class="gx-prod" id="gxFlagsProduct" aria-label="Flags Details">
        ...
        <div class="gx-prod-wrap">
            ...
            <div class="gx-prod-left">
                <div class="gx-prod-media">
                    <img
                        class="gx-prod-img"
                        src="{{ asset('assets/images/Flags/flag3.jpeg') }}"
                        alt="Flags"
                        loading="lazy"
                        decoding="async"
                    />
            ...
            <div class="gx-prod-right">
                <div class="gx-prod-head">
                    <h1 class="gx-prod-title">Flags</h1>
                    <p class="gx-prod-sub">
                        Premium promotional flags with vibrant printing, strong stitching, and durable outdoor finishing.
                    </p>
                </div>
                ...
                <div class="gx-details">
                    ...
                    <div class="gx-section">
                        ...
                        <p class="gx-sec-text">
                            Perfect for storefronts, events, exhibitions, and outdoor advertising. Our flags are designed
                            for clean visibility, easy mounting, and long-lasting color — ideal for UAE outdoor conditions.
                        </p>

                        <ul class="gx-bullets">
                            <li>Bright full-color printing with smooth gradients</li>
                            <li>Strong hemming &amp; neat finishing for outdoor use</li>
                            <li>Custom sizes, shapes (feather/teardrop/rectangle) &amp; branding</li>
                        </ul>
                    </div>
                    ...
                    <div class="gx-section gx-section--specs">
                        ...
                        <div class="gx-specrows" role="list">
                            <div class="gx-specrow" role="listitem">
                                ...
                                <div class="gx-spec-v">Knitted Polyester Fabric (110–115 GSM), Satin (indoor option), Canvas/Polyester Heading</div>
                            </div>

                            <div class="gx-specrow" role="listitem">
                                <div class="gx-spec-k">Supporting Material:</div>
                                <div class="gx-spec-v">Brass Grommets, Double-Stitched Hem, Sleeve/Pocket, Rope &amp; Toggle, Clips (optional)</div>
                            </div>

                            <div class="gx-specrow" role="listitem">
                                <div class="gx-spec-k">Options:</div>
                                <div class="gx-spec-v">Single/Double-sided print, Feather/Teardrop/Rectangle styles, Poles &amp; Bases (ground spike/cross base)</div>
                            </div>
                        </div>
                    </div>
                </div>
