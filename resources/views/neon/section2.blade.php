{{-- resources/views/neon/section2.blade.php --}}
<section class="gx-villa" id="gxNeonGallery" aria-label="Neon Sign Gallery">
            ...
            <div class="gx-gal" data-gx-gallery>
                <div class="gx-gal-main">
                    <img
                        ...
                        src="{{ asset('assets/images/neon/Neon7.jpeg') }}"
                        alt="Neon Sign"
                        loading="eager"
                        decoding="async"
                    />
                ...
                {{-- Thumbnails (5 images) --}}
                <div class="gx-gal-thumbs" role="list" aria-label="Neon Sign gallery thumbnails">
                    <button class="gx-thumb is-active" type="button" role="listitem"
                            data-src="{{ asset('assets/images/neon/Neon1.jpg') }}" aria-label="View image 1">
                        <img src="{{ asset('assets/images/neon/Neon1.jpg') }}" alt="Neon thumbnail 1" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/neon/Neon2.jpg') }}" aria-label="View image 2">
                        <img src="{{ asset('assets/images/neon/Neon4.jpg') }}" alt="Neon thumbnail 2" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/neon/Neon3.jpg') }}" aria-label="View image 3">
                        <img src="{{ asset('assets/images/neon/Neon5.jpg') }}" alt="Neon thumbnail 3" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/neon/Neon4.jpg') }}" aria-label="View image 4">
                        <img src="{{ asset('assets/images/neon/Neon6.jpg') }}" alt="Neon thumbnail 4" loading="lazy" decoding="async">
                    </button>

                    <button class="gx-thumb" type="button" role="listitem"
                            data-src="{{ asset('assets/images/neon/Neon5.jpg') }}" aria-label="View image 5">
                        <img src="{{ asset('assets/images/neon/Neon1.jpg') }}" alt="Neon thumbnail 5" loading="lazy" decoding="async">
                    </button>
                </div>
            </div>
        </div>
...
{{-- FAQ SECTION --}}
<section class="gx-faqs" id="gxNeonFaqs" aria-label="Frequently Asked Questions">
    <div class="gx-container">
            ...
            <div class="gx-faq-list" data-gx-faq>
                <div class="gx-faq is-open">
                    <button class="gx-q" type="button" aria-expanded="true">
                        How do I share my neon text/logo for a quote?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a">
                        <p>
                            Send your text or logo, preferred size, and color choice (single or multi-color). If you have a reference
                            photo or style idea, share it too — we’ll suggest the best layout and backboard shape.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Is LED neon safe and does it consume a lot of electricity?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            LED neon flex runs on low voltage (commonly 12V) and is designed for safe operation with lower power
                            consumption compared to traditional glass neon.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Can I choose brightness control (dimmer/remote)?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            Yes. We can add a dimmer or remote option depending on your design. This is great for cafés, bedrooms,
                            events, and photo backdrops.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    <button class="gx-q" type="button" aria-expanded="false">
                        Is outdoor neon available?
                        <span class="gx-ic" aria-hidden="true"></span>
                    </button>
                    <div class="gx-a" hidden>
                        <p>
                            Outdoor-ready options are available on request. We’ll recommend weather protection and installation
                            method based on location, heat, and exposure.
                        </p>
                    </div>
                </div>
                ...
                <div class="gx-faq">
                    ...
                    <div class="gx-a" hidden>
                        <p>
                            Production time depends on size and complexity, but most neon orders are completed quickly after design
                            confirmation.
                        </p>
                    </div>
                </div>
